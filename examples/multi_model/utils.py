...
def get_model_signature(input:pd.DataFrame, output:pd.Series, params:Dict[str, str])->ModelSignature:
    """
    ...
    input_params = [ParamSpec(name=param, dtype="string", default=value) for param, value in params.items()]
